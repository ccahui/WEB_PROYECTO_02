...
$(document).ready(function () {
  ...
  /*Prev hermano anterio de rpta el td codigo, nombre, nota 01,nota 02, nota 03*/
         ...
         * en la BD si no genera incopatibilidades*/
       for(var i=0;i<input.length;i++)
           if(input[i].value==="")
               input[i].value=null;
        $.ajax({
                     method:'get',
                     url:'../ProyectoColegio/tablaNota.php',
                     data:{
                         nota01:input[0].value,nota02:input[1].value,nota03:input[2].value,cursoCod:curCod,alumCod:alumno
                     },
